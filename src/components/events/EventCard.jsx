...
import { Calendar, MapPin, Bookmark, Share2, ExternalLink } from "lucide-react";
        ...
        <Link href={`/event/${event.id}`} className="block h-full">
            <GlassCard className="h-full flex flex-col hover:border-neon-blue/50 transition-all duration-300">
                ...
                <div className="p-5 flex-1 flex flex-col">
                    <div className="flex items-center gap-2 text-xs font-bold text-neon-blue mb-2 uppercase tracking-wider">
